                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products">
                            ...
                            <?php endforeach; ?>
                            <button class="btn btn-info center-block " data-toggle="collapse" data-target="#hide-me">Cписок авторов</button>
...
<!--                        <h2 class="title text-center">Случайное произведение</h2>-->
...
<!--                </div>-->
                ...
                <div class="col-sm-9 text-xs-center">
                    <div class="features_items"><!--features_items-->
                        <h2 class="title text-center"><?php echo $author; ?></h2>
